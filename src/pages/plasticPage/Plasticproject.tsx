                      ...
                      <div key={project.project_id} className="plasticCard">
                        <div className="plasticCardOutline">
                          ...
                          <div className="plasticCardBody">
                            ...
                            <div className="plasticCardTags"><b>Country: </b>{project.country}</div>
                            <div className="plasticCardTags"><b>Plastics: </b>
                              {project.plastics?.map((p) => (
                                <span key={p} className="plasticTag">{p}</span>
                              ))}
                            </div>
                            <div className="plasticCardTags"><b>Product: </b>{project.product}</div>
                      ...
                      <div key={project.project_id} className="plasticCard">
                        <div className="plasticCardOutline">
                          ...
                          <div className="plasticCardBody">
                            ...
                            <div className="plasticCardTags"><b>Year(s): </b> 
                            ...
                            <div className="plasticCardTags"><b>Product:</b> {project.product}</div>
                            <div className="plasticCardTags"><b>Financing:</b> {project.financing}</div>
                            <div className="plasticCardTags"><b>Business Model:</b> {project.businessModel}</div>
                            <div className="plasticCardTags"><b>Waste Collected:</b> {project.wasteCollected} tons</div>
                      ...
                      <div key={machine.id} className="plasticCard">
                        <div className="plasticCardOutline">
                          <div className="plasticCardBody">
                            ...
                            <div className="plasticCardTags"><b>Plastic types: </b>
                              {machine.plastics?.map((p) => (
                                <span key={p} className="plasticTag">{p}</span>
                              ))}
                            </div>
                            <div className="plasticCardTags"><b>What it does: </b>{machine.whatDoes}</div>
                          </div>
                        </div>
                      </div>
                    ) : (
                      ...
                      <div key={machine.id} className="plasticCard">
                        <div className="plasticCardOutline">
                          <div className="plasticCardBody">
                            ...
                            <div className="plasticCardTags"><b>How does it work and how is it aquired? </b>{machine.howDoes}</div>
                            <div className="plasticCardTags"><b>Operation complications and important lessons from projects: </b>{machine.complicLesson}</div>
                            <div className="plasticCardTags"><b>In use in EWB projects: </b>{machine.inUseEWB}</div>
                          </div>
                        </div>
                      </div>
                    )
