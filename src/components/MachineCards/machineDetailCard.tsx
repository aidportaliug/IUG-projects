...
const DetailedMachineCard: React.FC<DetailedMachineProps> = ({ id, title, picturePath, plasticType, whatDoes, howDoes, howWork, complicLesson, inUseEWB }) => {
    ...
    return (
        <div className="projectCardContainer" onClick={sendToMachinePage}>
            <div className="projectOutline">
                ...
                <div className='projectDescription'><b>How does it work and how is it required: </b>{howDoes}</div>
                <div className='projectDescription'><b>Operation complications and important lessons from projects: </b>{complicLesson}</div>
