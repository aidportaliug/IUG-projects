...
const ProjectDetailsPage : React.FC = () =>{
    ...
    const imageIcon = require("./../images/Trax_Ghana.png");
    ...
    return(
        <div className="projectDetailoutline">
            ...
            <InformationBox deadline={project.deadline.toDate()} location={project.location} duration={project.duration} studyField={project.studyField}></InformationBox>
