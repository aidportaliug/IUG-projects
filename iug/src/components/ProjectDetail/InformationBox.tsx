...
const InformationBox = ({deadline,location,duration,studyField}:InformationBoxProps)=>{
    return(
            <Stack spacing={2} style={{marginTop:"20px", width:"70%", borderBottom: "1px solid #3D7844", paddingBottom: "20px", marginBottom:"20px"}}>
                ...
                <div style={{fontSize:"20px"}}>
                    <div className="projectDetailDate">    
                        ...
                        <div style={{margin: "10px"}}> Application deadline: {deadline.getDate()}/{deadline.getMonth()}/{deadline.getFullYear()} </div>
                    </div>
                </div>
            </div>
        </Stack>
